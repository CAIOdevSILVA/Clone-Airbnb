    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg ralative flex flex-col w-full bg-white outlilne-none focus:outline-none"
            >
              {/* HEADER */}
              <div
              ...
              >
                <button
                  onClick={handleClose}
                  className="p-1 border-0 hover:opacity-70 transtion absolute left-9"
                >
                  <IoMdClose size={18}/>
                </button>  
                <div
